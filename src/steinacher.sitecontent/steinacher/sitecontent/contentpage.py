...
from steinacher.sitecontent import MessageFactory as _
...
class IContentPage(form.Schema, IImageScaleTraversable):
    """
    A content page with image preview capabilities
    """
    image = NamedBlobImage(
        title=_(u"Preview Image"),
        description=_(u"Upload preview image displayed in listings"),
        required=True,
    )
    text = RichText(
        title=_(u"Text"),
